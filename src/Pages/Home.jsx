...
const TECH_STACK = ["React", "Javascript", "Tailwind", "Cloud"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/nikhil-mangla" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/nikhil-mangla/" },
